...
Pod::Spec.new do |s|
  ...
  s.homepage       = "https://github.com/boliveira/react-native-vector-icons"
  s.license        = "MIT"
  s.author         = { "Joel Arvidsson" => "joel@oblador.se" }
  s.platform       = :ios, "7.0"
  s.source         = { :git => "https://github.com/boliveira/react-native-vector-icons.git", :branch => "fix_build_tools" }
